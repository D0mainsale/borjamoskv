"""
cortex_agentic.persist_membrane
================================
...
class PersistMembrane:
    ...
    async def commit_fact(
        ...
        try:
            ...
            # Local fallback: SHA-256 fingerprint stored in swarm_ledger.jsonl
            self._online = False
...
def _write_local_fallback(payload: Dict[str, Any], local_hash: str):
    """
    Writes to swarm_ledger.jsonl as SHA-256 fingerprinted fallback.
