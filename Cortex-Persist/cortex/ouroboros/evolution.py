"""
Agents.archi-Swarm — The Sovereign Topology.
L1 Supervisor: orchestrates each agent as a sovereign tactical unit within the Swarm.
...
class EvolutionSupervisor:
    ...
    def _compute_ontology_similarity(
        ...
        Adapted for Agents.archi: uses seed_hash stability and score progression.
        """
        if not lineage:
